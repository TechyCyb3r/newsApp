...
export class NewsItem extends Component {
  render() {
    ...
    return (
      <>
        <div className="card d-flex flex-column" style={{ width: "19rem, height:40px", marginTop: "20px", alignContent: "space-between", alignItems: "center", justifyContent: "center", display:"grid", flexWrap:"wrap"}}>
